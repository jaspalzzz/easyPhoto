      ...
      >
        ...
        <div className="flex items-center gap-3 border-b border-hairline px-4 py-3.5">
          ...
          <button
            onClick={closePalette}
            aria-label="Close"
            className="rounded-md border border-hairline px-1.5 py-0.5 text-xs font-semibold text-muted-foreground hover:border-ink-soft hover:text-ink"
          >
            Esc
          </button>
        </div>
        ...
        <div className="flex items-center gap-4 border-t border-hairline px-4 py-2.5">
          <span className="flex items-center gap-1 text-xs text-muted-foreground">
            <kbd className="rounded border border-hairline px-1 py-0.5 text-xs font-mono">↑↓</kbd>
            navigate
          </span>
          <span className="flex items-center gap-1 text-xs text-muted-foreground">
            <kbd className="rounded border border-hairline px-1 py-0.5 text-xs font-mono">↵</kbd>
          ...
          <span className="flex items-center gap-1 text-xs text-muted-foreground">
            <kbd className="rounded border border-hairline px-1 py-0.5 text-xs font-mono">Esc</kbd>
            close
          </span>
        </div>
      </div>
