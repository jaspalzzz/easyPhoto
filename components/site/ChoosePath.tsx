...
const PATHS: Path[] = [
  {
    ...
    desc: `Photo, signature and document sizes for ${EXAM_COUNT}+ Indian exam and recruitment forms — each linked to a named source and clearly labelled when current figures still need review.`,
    href: "/exam-requirements/",
    cta: "Find your exam or form",
    chips: [
      { label: "SSC", href: "/exam-requirements/ssc/" },
      { label: "UPSC", href: "/exam-requirements/upsc/" },
      { label: "Voter ID", href: "/exam-requirements/voter-id/" },
      { label: "Railway", href: "/exam-requirements/rrb/" },
      { label: "Banking", href: "/exam-requirements/ibps/" },
    ],
  ...
  return (
    ...
    >
      <div className="mb-4 flex items-center justify-between">
        ...
        {featured && (
          <span className="inline-flex items-center gap-1 rounded-full border border-cta bg-cta px-2.5 py-0.5 text-xs font-bold uppercase tracking-wider text-cta-foreground">
