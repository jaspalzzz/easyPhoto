 ...
 * Premium redesign: 3-panel flow + 4-step strip
 */
...
const AI_CHECKS = [
  {
    ...
    icon: (
      <svg viewBox="0 0 16 16" fill="none" className="h-4 w-4 text-indigo-600">
...
export function AiShowcase() {
  return (
    <section
      ...
      style={{ background: "linear-gradient(180deg, #f5f3ff 0%, #fafaff 60%, #ffffff 100%)" }}
    >
      <div className="container py-16 sm:py-20">

        {/* Heading */}
        <div className="mb-12 text-center">
          <h2 className="text-[2.4rem] font-bold tracking-tight text-[#0f172a] sm:text-[2.8rem]">
            <span
              style={{
        ...
        <div className="grid grid-cols-1 items-center gap-4 md:grid-cols-[1fr_52px_1.1fr_52px_1fr]">
          ...
          <div className="rounded-2xl border border-[#e0e7ff] bg-white p-6 shadow-[0_8px_36px_rgba(79,70,229,0.13)]">
            ...
            <div className="mb-5 flex flex-col items-center">
              <div className="relative mb-3">
                ...
                <span className="absolute -top-2 -right-1 text-[18px] leading-none text-indigo-400">✦</span>
                <span className="absolute -bottom-1 -left-2 text-[12px] leading-none text-purple-400 opacity-60">✦</span>
                <span className="absolute top-0 -left-3 text-[8px] leading-none text-indigo-300 opacity-50">✦</span>
              </div>
        ...
        <div className="relative mt-16">
          ...
          <div
            ...
            style={{ borderTop: "2px dashed #c7d2fe" }}
          />
          ...
          <ol className="grid grid-cols-2 gap-8 md:grid-cols-4 md:gap-4">
            {STEPS.map((step) => (
              <li key={step.label} className="flex flex-col items-center text-center">
                <div
                  className="relative z-10 flex h-11 w-11 items-center justify-center rounded-full shadow-[0_4px_14px_rgba(79,70,229,0.30)]"
