...
const TOOL_DEPTH: Record<string, ToolDepthCopy> = {
  ...
  "aadhaar-ocr": {
    ...
    paragraphs: [
      ...
      "Think about what you actually need before extracting anything. Most forms that ask for Aadhaar want the last four digits, or a masked copy with the first eight hidden \u2014 UIDAI publishes a masked download for exactly this. Pulling the full number into a text box and pasting it somewhere it is not required is the more common privacy mistake, and it is easier to avoid at this step than to undo later.",
    ],
    checklist: [
