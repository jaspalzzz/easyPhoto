...
export default function Page() {
  return (
    <ToolPage
      ...
      blurb={`Resize and compress your passport photo to ${spec.photoMinKb}–${spec.photoLimitKb} KB${photoDims} for the NDA (National Defence Academy) application on upsconline.nic.in.`}
