...
const spec = getPortalSpec("nda")!;
const prov = specProvenance(spec);

export const metadata = pageMetadata({
  title: "NDA Photo Resizer 2026 — Compress Photo for NDA Application",
  description: resizerMetaDescription(spec, "NDA"),
  path: "/nda-photo-resizer/",
});
...
export default function Page() {
  return (
    <ToolPage
      ...
      blurb={`Resize and compress your passport photo to ${spec.photoMinKb}–${spec.photoLimitKb} KB and ${spec.photoWidthPx}×${spec.photoHeightPx}px for the NDA (National Defence Academy) application on upsconline.nic.in.`}
    ...
    >
      ...
      <ExamResizerSteps spec={spec} slug="nda" />
