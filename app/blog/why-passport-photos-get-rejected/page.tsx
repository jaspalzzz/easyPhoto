  ...
  return (
    <BlogPostLayout slug={post.slug}>
      ...
      <p>
        ...
        crown on a 2×2 inch photo; India wants a notably larger face. A
        generic square crop won&apos;t match. The{" "}
        <Link href="/passport-photo/">passport photo maker</Link> sizes the head
        to the exact band per country, which removes this entirely.
      </p>
      ...
      <p>
        ...
        raised eyebrows will also fail a biometric check — keep a relaxed, neutral
        expression with your mouth closed.
      </p>
      ...
      <p>
        ...
        far too big. Compress the finished photo with{" "}
        <Link href="/tools/resize-image-to-20kb/">resize to 20 KB</Link> or{" "}
        <Link href="/tools/resize-image-to-50kb/">50 KB</Link> to fit.
      </p>

      <h2>Old photo or wrong document type</h2>
      <p>
        Most countries want a photo taken within the last six months. And a visa
        photo isn&apos;t always the same as a passport photo — check the right
