...
export const metadata: Metadata = {
  title: "Terms of Use",
  description:
    "Terms of use for PassportPhoto — a free, in-browser passport/visa photo " +
    ...
    <div className="container max-w-3xl py-12">
      ...
      <article className="mt-6 space-y-6">
        ...
        <Section title="The service">
          PassportPhoto is a free tool that helps you prepare passport, visa, and
        ...
        <Section title="No affiliation">
          PassportPhoto is an independent tool and is not affiliated with,
