        ...
        <section key={group.source} className="mt-12">
          ...
          <div className="ep-card-grid">
            {group.pairs.map((p) => (
              ...
              >
                <span className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-[hsl(212_88%_48%/0.18)] text-[hsl(212_90%_44%)] dark:bg-[hsl(212_88%_48%/0.25)] dark:text-[hsl(212_90%_68%)] transition-colors group-hover:bg-[hsl(212_88%_48%/0.28)]">
