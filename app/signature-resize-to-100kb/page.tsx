...
const uc = SIGNATURE_KB_USECASES[100];

export const metadata = pageMetadata({
  title: "Signature Resize to 100KB – Free, Keeps Transparency",
  titleAbsolute: true,
  description:
    "Resize your signature to under 100 KB — for UPSC and forms that accept a full " +
    "signature sheet. Transparent background kept, in your browser. No upload.",
  path: PATH,
});
...
export default function Page() {
  return (
    <div className="container max-w-3xl py-10">
      ...
      <KbExamLinks kind="signature" kb={100} />
