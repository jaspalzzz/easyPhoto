...
export default function Page() {
  return (
    <ToolPage
      ...
      blurb={`Resize and compress your passport photo to under ${spec.photoLimitKb} KB (${spec.photoMinKb}–${spec.photoLimitKb} KB)${photoDims} for IBPS online bank application forms.`}
