...
export default function Page() {
  return (
    <ToolPage
      ...
      blurb={`Current RRB applications capture the photograph live. Prepare the separate ${spec.sigMinKb}–${spec.sigLimitKb} KB${spec.sigFormat ? ` ${spec.sigFormat}` : ""} signature here; the optional photo tool is a compatibility aid, not the current live-photo step.`}
