...
export default function Page() {
  return (
    <ToolPage
      ...
      blurb={`Resize and compress your passport photo to the ${spec.photoMinKb}–${spec.photoLimitKb} KB range${photoDims} listed for the Staff Selection Commission portal.`}
