...
export const TOOLS_CATALOG: ToolGroup[] = [
  {
    ...
    tools: [
      ...
      },
      {
        ...
        blurb: "Capture a photo with your phone or webcam using an oval face guide — no need to upload a file.",
        ready: true,
        popular: true,
        icon: "Camera",
      },
      {
        ...
        blurb: "Combine your photo and signature into one image for forms that need both on a single page.",
        ready: true,
        icon: "Combine",
      },
      {
        slug: "dpi-converter",
        title: "Change Image DPI (200 / 300)",
        blurb: "Set a JPG's DPI tag for NSDL PAN (200) or printing (300) without re-compressing the pixels.",
        ready: true,
        icon: "Gauge",
      },
      {
