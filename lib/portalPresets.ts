...
export const PORTAL_PRESETS: Record<string, PortalSpec> = {
  ...
  cat: {
    ...
    sigLimitKb: 80,
    description:
      "IIM Common Admission Test registration (iimcat.ac.in). Photo and signature each JPG/JPEG up to 80 KB. Recent colour photo on a white or light background, no selfies; signature 80×35 mm in ballpoint pen, scanned. Reported dimensions vary by cycle — the portal validates at upload.",
    source: { url: "https://iimcat.ac.in", label: "CAT registration (iimcat.ac.in)" },
