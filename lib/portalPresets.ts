...
export const PORTAL_PRESETS: Record<string, PortalSpec> = {
  ...
  rrb: {
    ...
    photoAspectRatio: 3.5 / 4.5,
    sigAspectRatio: 14 / 6,
    description: "Railway Recruitment Board (rrbapply.gov.in). Photo ~20-100 KB, signature ~10-40 KB. Limits vary by sub-exam (NTPC/Group D/ALP) — confirm the current notification.",
