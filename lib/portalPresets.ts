...
export const PORTAL_PRESETS: Record<string, PortalSpec> = {
  ...
  kpsc: {
    ...
    photoAspectRatio: 1,
    sigAspectRatio: 1,
    description: "Karnataka PSC registration upload. Photo up to 200 KB at 100x100 to 150x150 px; signature up to 50 KB at 50x50 to 150x150 px; JPG/JPEG/PNG. The stored 150x150 px targets represent the upper end of each published range; check the current recruitment screen for any tighter rule.",
    source: {
      url: "https://apply.registernow.in/KPSC/Registration/",
      label: "KPSC online application — registration upload instructions",
    },
    verification: "official",
    verifiedOn: "2026-07-17",
    context:
      "The current KPSC-branded registration portal asks the candidate to upload photo and signature files and publishes pixel ranges and maximum file sizes. It is an upload workflow, not live photograph capture, and allows PNG in addition to JPG/JPEG. Specific recruitment instructions may set tighter limits.",
  },
  appsc: {
    id: "appsc",
