...
export const SUB_EXAM_RESIZERS: SubExamResizer[] = [
  // SSC
  {
    ...
    note: "SSC CGL recruits graduates for Group B and Group C posts — Inspector, Assistant Audit Officer, Tax Assistant and similar roles across central government ministries. The photo and signature are uploaded once during the One-Time Registration on ssc.gov.in and reused for every later SSC application.",
  },
  {
    slug: "ssc-chsl",
    parentId: "ssc",
    ...
    note: "SSC CHSL is the 10+2 level exam for Lower Division Clerk, Data Entry Operator and postal assistant posts. Because it shares the same One-Time Registration as every other SSC exam, the photo and signature you upload here are the ones reused for CGL, MTS and the rest.",
  },
  {
    slug: "ssc-gd",
    parentId: "ssc",
    ...
    note: "SSC GD Constable recruits for the Central Armed Police Forces — BSF, CISF, CRPF, ITBP and SSB — plus Assam Rifles and the NIA. Candidates register through the standard SSC One-Time Registration, so the same photo and signature specification applies.",
  },
  {
    slug: "ssc-mts",
    parentId: "ssc",
    ...
    note: "SSC MTS fills non-technical Group C Multi Tasking Staff and Havaldar posts in central government departments. It uses the same SSC One-Time Registration portal, so the photo and signature limits match every other SSC exam.",
  },
  {
    slug: "ssc-cpo",
    parentId: "ssc",
    ...
    note: "SSC CPO recruits Sub-Inspectors in Delhi Police and the Central Armed Police Forces. The photo and signature are submitted through the SSC One-Time Registration on ssc.gov.in, identical to the spec used for CGL and CHSL.",
  },
  {
    slug: "ssc-je",
    parentId: "ssc",
    ...
    note: "SSC JE recruits Junior Engineers in Civil, Mechanical and Electrical streams for central government organisations. Registration runs through the same SSC One-Time Registration, so the photo and signature requirements are shared across all SSC exams.",
  },
  {
    ...
    note: "SSC Stenographer recruits Grade C and Grade D stenographers for central government ministries and departments. As with every SSC exam, the photo and signature are uploaded once at One-Time Registration and reused.",
  },
  // IBPS / Banking
  {
    slug: "ibps-po",
  ...
  // UPSC
  {
    ...
    note: "UPSC CSE is the Civil Services Examination that recruits for the IAS, IPS, IFS and allied services. The photo and signature are uploaded on the UPSC One Time Registration portal, and UPSC additionally requires your name and the photo date printed on the image.",
  },
  {
    slug: "upsc-nda",
    parentId: "upsc",
    ...
    note: "UPSC NDA selects candidates for the National Defence Academy's Army, Navy and Air Force wings. It is conducted by UPSC, so the photo and signature upload follows the same UPSC specification, including the printed name-and-date requirement.",
  },
  {
    slug: "upsc-cds",
    parentId: "upsc",
    ...
    note: "UPSC CDS recruits officers for the Indian Military Academy, Naval Academy, Air Force Academy and Officers' Training Academy. As a UPSC exam, it shares the same photo and signature specification, with the name-and-date-on-photo rule.",
  },
  // NTA
  {
    slug: "neet",
