...
| URL | Claim | Official source URL | Source title | Source date | Verified date | Confidence | Status |
| --- | --- | --- | --- | --- | --- | --- | --- |
| /exam-requirements/voter-id/ | Form 6 item 1(d) requires a recent good-quality unsigned colour photograph measuring 4.5×3.5 cm, with a white background, open eyes and both face edges visible. The public instruction publishes no digital KB cap, pixel dimensions, format, DPI or name/date rule. | https://voters.eci.gov.in/guidelines/Form-6_en.pdf | ECI Guidelines for Filling Up Form-6 | PDF undated | 2026-07-16 | Unverified | **Downgraded to needs-review.** The physical size, aspect and composition remain confirmed. The stored 2 MB digital target is compatibility-only because no current public first-party source was found for it. |
