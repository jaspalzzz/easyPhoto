...
| /exam-requirements/kpsc/ | The current KPSC-branded registration portal uses separate photo and signature uploads. It accepts a photo up to 200 KB at 100×100–150×150 px and a signature up to 50 KB at 50×50–150×150 px, in JPG/JPEG/PNG. It publishes no minimum KB value, DPI, ink or name/date rule. | https://apply.registernow.in/KPSC/Registration/ | KPSC online application — Registration upload instructions | Live registration page, © 2026 | 2026-07-17 | Confirmed | **Confirmed.** Retained 150×150 px as the tool's upper-range target, added square aspect ratios and replaced the bare homepage citation with the upload page. |
